...
public class CardDealer {
    ...
    private void initTreasureCardDeck (){
        ...
        unusedTreasures.add (new Treasure ("Camiseta ETSIIT", 1, TreasureKind.ARMOR));
        ...
        unusedTreasures.add (new Treasure ("Zapato deja-amigos", 3, TreasureKind.SHOE));
    ...
    private void initMonsterCardDeck(){
        ...
        bc = new BadConsequence ("Pierdes tu armadura visible y otra oculta", 0, 
                ...
                new ArrayList(Arrays.asList(TreasureKind.ARMOR)));
        prize = new Prize (2, 1);
        unusedMonsters.add (new Monster ("Byakhees de bonanza", 8, bc, prize));
        ...
        bc = new BadConsequence("Estos unusedMonsters resultan bastante superficiales "
    ...
    /**
     * 
     * Introduce el tesoro en el mazo de descartados de tesoros
    ...
    /**
     * 
     * Introduce el monstruo en el mazo de descartados de monstruos
